...
<head>
    ...
    <body>
        ...
        <div id="loginbox">            
            <form id="loginform" class="form-vertical" action="${ctx}/devLogin.do" method="post"/>
				<p style="color:red">${error}</p>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-user"></i></span><input type="text" name="devCode" placeholder="请输入用户名" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <div class="input-prepend">
                            <span class="add-on"><i class="icon-lock"></i></span><input type="password" name="devPassword" placeholder="请输入密码" />
                        </div>
                    </div>
                </div>
